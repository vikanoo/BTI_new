...
- ЗАПРЕТЫ: нет окна в помещении → окно не упоминать. Запрещены общие фразы типа "Стык стен". Запрещены вводные слова и неуверенные формулировки: "скорее всего", "возможно", "вероятно", "предположительно", "по всей видимости" — пиши location как чёткую команду, например "В дальнем левом углу от входа".
