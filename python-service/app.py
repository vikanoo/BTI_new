...
- СТОП. Перед тем как написать название — задай себе вопрос: "Я вижу это слово напечатанным на плане?" Если нет — пиши "Помещение [id]".
- ЗАПРЕЩЕНО угадывать или выводить название из: значков сантехники (раковина, унитаз, ванна, плита), формы помещения, размера, расположения, предполагаемого назначения. Видишь плиту — не пишешь "Кухня". Видишь унитаз — не пишешь "Санузел". Только напечатанный текст.
- Алгоритм: смотришь внутрь контура → ищешь напечатанное слово-название → нашёл слово → используешь → не нашёл → пишешь "Помещение [id]".
