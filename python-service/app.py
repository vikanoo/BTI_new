...
Data Schema (JSON):
Для каждого помещения (room_id) создай массив объектов, где текст строго соответствует шаблону со скриншота:

location: (string) Строго в формате "у [объект]" или "в углу у [объект]" (например, "у двери в комнату").
view: (string) Строго в формате "на [объект] и [объект]" (например, "на раковину и душевую кабину").
short_task: (string) Короткое действие в инфинитиве (например, "сфотографировать весь санузел" или "сфотографировать обстановку столовой").
