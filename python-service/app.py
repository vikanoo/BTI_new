...
1. "location": Короткая позиция человека с камерой. Где он стоит? 
   Пример: "В углу у входа", "У смежной стены с кухней".
2. "view": Куда конкретно направлен объектив. Что именно попадает в кадр?
   - КРИТИЧЕСКОЕ ПРАВИЛО: Запрещено писать размытые фразы вроде "на все стены", "на все углы", "на комнату". Направление должно быть конкретным: на какую именно стену, проем или угол смотрит человек.
   Пример: "На противоположный угол и фасадную стену", "На дверной проем и левую перегородку".
3. "description": Главная техническая задача этого кадра.
