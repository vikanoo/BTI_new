...
Алгоритм выбора количества точек:

Площадь < 6 м²: ровно 2 точки (диагональный обзор).

Площадь 6–20 м² (прямоугольник): ровно 2 точки (противоположные углы).

Площадь 6–20 м² (сложная форма/Г-образная): ровно 3 точки.

Площадь > 20 м²: ровно 4 точки.
