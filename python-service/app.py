...
- КОПИРУЙ ДОСЛОВНО: если на плане написано "Ванная" — пиши "Ванная", не "Санузел". Если написано "Лоджия" — пиши "Лоджия", не "Балкон" и не "Площадка". Если написано "Жилая" — пиши "Жилая", не "Комната". Никаких синонимов, никакого перевода, никакой нормализации — только точный текст с плана.
